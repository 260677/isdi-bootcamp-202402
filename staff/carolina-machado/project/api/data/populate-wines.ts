...
mongoose.connect('mongodb://localhost:27017/project')
    .then(() => Wine.deleteMany())
        .then(() =>
            ...
            Wine.create({ image: `https://imgbox.com/NSvRLleB`, title: 'Onix Priorat', description: 'syrah and garnache, cherry notes', type: 'red', price: 6 }),
            ...
            Wine.create({ image: `https://imgbox.com/NSvRLleB`, title: 'Red Butterflies Priorat', description: 'cherry, wood', type: 'red', price: 18 }),
            Wine.create({ image: `https://imgbox.com/NSvRLleB`, title: 'Nero dAvola', description: '6 month roble, fruity and dry', type: 'red', price: 19 }),
            Wine.create({ image: `https://imgbox.com/NSvRLleB`, title: 'Brunello de Montalcino', description: 'notes of cherry, blueberry and soil, smoked', type: 'red', price: 22 }),
            Wine.create({ image: `https://imgbox.com/NSvRLleB`, title: 'Pink Flamingo', description: 'natural wine, young and fresh', type: 'pink', price: 3 }),
            Wine.create({ image: `https://imgbox.com/NSvRLleB`, title: 'Rose Bouquet', description: 'lemon, lily, roses', type: 'pink', price: 5 }),
            Wine.create({ image: `https://imgbox.com/NSvRLleB`, title: 'Cherry Lips', description: 'intense and dry', type: 'pink', price: 7 }),
            Wine.create({ image: `https://imgbox.com/NSvRLleB`, title: 'Chic Rosé', description: 'rose, lemon and sweet cotton notes', type: 'pink', price: 10 }),
            Wine.create({ image: `https://imgbox.com/NSvRLleB`, title: 'Pink Bubbles', description: 'cherry, lemon and dry cotton notes', type: 'pink', price: 12 }),
