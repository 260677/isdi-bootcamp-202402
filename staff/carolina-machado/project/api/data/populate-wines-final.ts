...
mongoose.connect('mongodb://localhost:27017/project')
    .then(() => Wine.deleteMany())
        .then(() =>
            ...
            Wine.create({ image: `https://images2.imgbox.com/68/8d/IDqtKX0J_o.png`, title: 'Ribera del Duero Celeste', description: '6 months french oak, strong and balanced, cherry notes. Perfect to enjoy with strong cheeses or meat.', type: 'red', price: 9.35, rates: [4.8] }),
            ...
            Wine.create({ image: `https://images2.imgbox.com/3f/10/ZDgxW2JO_o.png`, title: 'Protos', description: '3 months french oak, 100% verdejo, fresh and vibrant', type: 'white', price: 7.65, rates: [4.6] }),
            ...
            Wine.create({ image: `https://images2.imgbox.com/31/96/HTr605lJ_o.png`, title: 'Tal com Raja', description: '6 months in french roble, strong and balanced, cherry and mineral notes', type: 'red', price: 6.65, rates: [4.3] }),
