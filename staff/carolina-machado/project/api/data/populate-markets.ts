...
mongoose.connect('mongodb://localhost:27017/project')
    ...
    .then(() => {
        ...
        return Promise.all([
            Market.create({ title: 'Mercadona', address: 'Calle Calabria, 129', location: point1, wines: ['662e80da9bd0437d6003be78', '662e80da9bd0437d6003be87', '662bc0b43f7b2f41c2b230ea'] }),
